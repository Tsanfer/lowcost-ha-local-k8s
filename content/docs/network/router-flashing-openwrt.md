...
​`/h.pigsty/g.pigsty/p.pigsty/a.pigsty/pgsql-primary.lan/192.168.0.51`​
...
do_auth() {
    log "尝试认证: 账号: ${DDDDD}"
    curl -s -m 5 "${AUTH_URL}?callback=dr1004&DDDDD=${DDDDD}&upass=${UPASS}&0MKKey=123456&R3=${ISP_CODE}" > /dev/null
}
